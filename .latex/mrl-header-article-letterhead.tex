...
\definecolor{themecolour}{HTML}{563E82} % Pantone 7679C
...
\postauthor{\end{center}\vspace{-6ex}}
\predate{\begin{center}}
\postdate{\end{center}\vspace{-6ex}}
...
\setlist[description]{
  font=\sffamily\bfseries\color{themecolour},
  leftmargin=3in,
  itemindent=0in,
  labelwidth=*,
  topsep=0pt,
...
% Define a short title for header elements
\newcommand{\shorttitle}{}

% The article class uses the plain style for the first page, so we redefine:
\fancypagestyle{plain}{%
  \fancyhf{}
  \fancyhead[C]{%
    \hspace*{-0.75in}
    \includegraphics[width=8.5in]{~/.latex/unity_letterhead_header.pdf}
  }
  % \fancyfoot[C]{%
  %   \includegraphics[scale=0.6]{unity_letterhead_footer.pdf}
  % }
  \fancyfoot[L]{\ltseries\small\shorttitle}
  \fancyfoot[C]{\ltseries\small{}Page \thepage\ of \pageref{LastPage}}
  \fancyfoot[R]{\ltseries\small{}Version Date: \versiondate}
