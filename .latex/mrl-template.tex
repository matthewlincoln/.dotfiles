...
\setkomafont{disposition}{\sffamily\sbseries\color{themecolour}}
\setkomafont{section}{\large\sffamily\sbseries\color{themecolour}}
...
\RedeclareSectionCommand[
  ...
  runin=false,
  tocentryformat=\small\rmfamily,
  tocpagenumberformat=\small\rmfamily
]{section}
\RedeclareSectionCommand[
  beforeskip=0pt,
  afterskip=-\parskip,
  runin=false,
  tocentryformat=\small\rmfamily\itshape,
  tocpagenumberformat=\small\rmfamily\itshape
]{subsection}
\RedeclareSectionCommand[
  beforeskip=0pt,
  afterskip=-\parskip,
...
% Reduce TOC spacing:
% \RedeclareSectionCommand[tocbeforeskip=1ex plus 1pt minus 1pt]{section}
\RedeclareSectionCommand[tocbeforeskip=0pt]{section}

% Style figure captions:
\setkomafont{caption}{\sffamily\ltseries}
\setkomafont{captionlabel}{\sffamily\sbseries\color{themecolour}}
...
\renewcommand\Affilfont{\rmfamily\small\itshape}
